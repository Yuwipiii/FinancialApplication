        ...
        <template #main>
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="grid grid-cols-6 gap-2 mb-10">
                        <div
                            ...
                            <div class="grid grid-cols-1 p-10">
                                ...
                                <div>
                                    <p class="text-emerald-600 text-3xl me-1">{{
                                            formatPrice(this.netWorth)
                                        }} KGS</p>
                                </div>
                            </div>
                        </div>
                        <div class="lg:col-span-4 md:col-span-4 col-span-6 mb-10 text-gray-200">
                            <div class="grid grid-cols-6 gap-2 bg-gray-600   rounded-lg shadow-xl p-4">
                        ...
                        <div class="col-span-6 bg-gray-600 p-5 rounded-lg shadow-xl mb-15">
                            <h2 class="font-semibold text-2xl  text-gray-200 leading-tight text-center mb-4">New
                                Transaction</h2>
                        ...
                        <div
                            class="lg:col-span-3 md:col-span-3 col-span-6  bg-gray-600 text-white p-5 rounded-lg shadow-xl mb-15">
                            <h2 class="font-semibold text-2xl leading-tight text-center mb-4">
                                Currency Converter</h2>
                            <div class="flex justify-around gap-2 mb-4">
                                <div>
                                    <div class="text-sm">From currency</div>
                                    <select class="bg-gray-700 rounded-lg" v-model="fromCurrency">
                                ...
                                <div>
                                    ...
                                    <input type="number" min="1" step="0.1" v-model="amount"
                                           class="bg-gray-700  rounded w-full"/>
                                </div>
                                <div>
                                    <div class="text-sm">To currency</div>
                                    <select class="bg-gray-700  rounded-lg" v-model="toCurrency">
                            ...
                            <button @click="convertCurrency" class="bg-emerald-600 px-4 py-2 rounded-full w-full mb-15">
                                Convert
                            </button>
                            <div v-if="convertedAmount !== null" class="text-2xl text-emerald-600 text-center mb-4">
                                {{ formatPrice(convertedAmount) + " " + toCurrency }}
                            </div>
                            <div v-else-if="convertedError !== null" class="text-2xl text-center text-red-600 mb-4">
                                {{ convertedError }}
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-5 gap-2 bg-gray-600 rounded-lg shadow-xl p-10">
                        <h2 class="font-semibold col-span-5  text-2xl text-gray-200 leading-tight text-center mb-4">
                            Analytics</h2>
                        <div class="col-span-5 grid grid-cols-3 gap-1 mb-10 text-gray-200">
                            <div
                                class="p-3 rounded-lg bg-gray-700  pt-4 pb-4 hover:scale-95 hover:bg-slate-400/50 shadow-xl"
                        ...
                        <div class="col-span-5">
                            ...
                            <div v-show="showMonthly">
                                <div class="grid grid-cols-2">
                                    <apexchart class="col-span-2 lg:col-span-1 md:col-span-1" :width="monthlyExpensesChart.width"
                                    ...
                                    ></apexchart>
                                    <apexchart class="col-span-2 lg:col-span-1 md:col-span-1" :width="monthlyIncomesChart.width"
                            ...
                            <div v-show="showYearly">
                                <div class="grid grid-cols-2">
                                    <apexchart class="col-span-2 lg:col-span-1 md:col-span-1" :width="yearlyExpensesChart.width"
                                    ...
                                    ></apexchart>
                                    <apexchart class="col-span-2 lg:col-span-1 md:col-span-1" :width="yearlyIncomesChart.width"

                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <div>
                            <div
                                ...
                                @click="this.showNetWorth  = !showNetWorth">
                                <p>Net Worth</p>
                                <div>
                            ...
                            <Transition name="bounce">
                                <div
                                    ...
                                    <div v-for="(wallet,index) in wallets" :key="index">
                                        <div
                                            class="flex mt-3 justify-around bg-slate-400 pt-2 pb-2 rounded-lg shadow-2xl hover:scale-95 hover:bg-slate-400/50 ">
                                            <div>
                                                <p>{{ wallet.name }}</p>
                                                <p>{{ wallet.type }}</p>
                                            </div>
                                            <div>
                                                <p class="text-emerald-800">{{
                                                        formatPrice(this.netWorthKGS) + ' KGS'
                                                    }}</p>
                                            </div>
                                        </div>
                                    </div>

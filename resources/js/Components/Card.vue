        ...
        <div>
            <div class="flex flex-col mb-3">
                <div class="flex justify-between">
                    ...
                    <Modal :show="this.showDeleteModal" @close="closeModal">
                        <div class="p-6">
                            <h2 class="text-lg font-medium text-gray-900">Are you sure you want to delete your wallet ?</h2>
...
export default {
    components: {InputLabel, InputError, SecondaryButton, DangerButton, Modal, TextInput},
    data() {
        return {

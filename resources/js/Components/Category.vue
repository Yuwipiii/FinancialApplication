<template>
    <div @click="showCategory" >
        <div class="card group/item  bg-gray-600 hover:bg-gray-400 drop-shadow-lg">
                ...
                <div class="flex justify-between text-gray-200">
                    ...
                    <Modal :show="this.showDeleteModal" @close="closeDeleteModal">
                        <div class="p-6 bg-gray-600">
                            <h2 class="text-lg font-medium text-gray-200">Are you sure you want to delete category expense
                                ?</h2>
            ...
            <div>
                <div class="card-info text-end text-gray-200">
                    <p><strong>Monthly limit: </strong>{{formatPrice(categoryMonthlyLimit)}} KGS</p>
                </div>
            </div>
        </div>
    </div>
